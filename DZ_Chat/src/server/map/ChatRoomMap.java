...
public class ChatRoomMap {
	...
	public static void init() {
		...
		try {
			chatRoomProperties.load(new InputStreamReader(
					new FileInputStream(propertiesPath), "UTF-8"));
	...
	public static void record() {
		...
		try {
			chatRoomProperties.store(new OutputStreamWriter(
					new FileOutputStream(new File(propertiesPath)), "UTF-8"), null);
		} catch (IOException e) {
		}
	}
